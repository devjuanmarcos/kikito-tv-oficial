...
export function DataTableToolbar<TData>({ table, children, className, ...props }: DataTableToolbarProps<TData>) {
  ...
  return (
    <div
      ...
      className={cn("flex w-full flex-nowrap items-center justify-between gap-2 p-1", className)}
      {...props}
    >
      <div className="flex min-w-0 flex-1 flex-wrap lg:flex-nowrap items-center gap-2 overflow-x-auto">
        {columns.map((column) => (
        ...
        case "text":
          return (
            <InputSearch
              ...
              className="bg-background h-8 w-40 lg:w-56"
            />
          );
