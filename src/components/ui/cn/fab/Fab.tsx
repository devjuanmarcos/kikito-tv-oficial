        ...
        <div className={cn('flex', actionsDir, 'gap-2')}>
          {actions.map((action, i) => (
            <div key={i} className="flex items-center gap-2 group">
              <span className="text-body-caption text-foreground bg-raised border border-rule rounded px-2 py-0.5 whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none select-none">
                {action.label}
              </span>
              <button
                type="button"
