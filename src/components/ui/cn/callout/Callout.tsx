...
const INTENT_VARS: Record<string, string> = {
  ...
  success:
    "[--i:var(--ks-success)] [--i-fg:var(--ks-success-fg)] [--i-soft:var(--ks-success-soft)] [--i-deep:var(--ks-success-deep)]",
  warning:
    "[--i:var(--ks-warning)] [--i-fg:var(--ks-warning-fg)] [--i-soft:var(--ks-warning-soft)] [--i-deep:var(--ks-warning-deep)]",
  danger:
    "[--i:var(--ks-danger)] [--i-fg:var(--ks-danger-fg)] [--i-soft:var(--ks-danger-soft)] [--i-deep:var(--ks-danger-deep)]",
    ...
    >
      ...
      <div className="flex-1 min-w-0 flex flex-col gap-(--spacing-2xs)">
        ...
        {children && (
          <div
            className={cn(
              "text-body-callout leading-relaxed",
              isSolid ? "text-[color-mix(in_oklch,var(--i-fg)_85%,transparent)]" : "text-muted"
            )}
          >
            {children}
          </div>
