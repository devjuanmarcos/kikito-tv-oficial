...
export function CnPageHeader({ group, groupLabel, title, description }: CnPageHeaderProps) {
  return (
    <header className="mb-8">
      {/* ── Breadcrumbs ─────────────────────────────────────────────── */}
      <nav
        className="flex items-center gap-1 text-[0.8125rem] text-muted mb-5"
      ...
      <div className="flex items-start gap-3 mb-2.5">
        <h1 className="text-[1.875rem] font-bold text-foreground leading-tight tracking-tight">
          {title}
        </h1>
      ...
      {/* ── Description ─────────────────────────────────────────────── */}
      <p className="text-[0.9375rem] leading-relaxed text-muted max-w-2xl">
        {description}
      </p>
    </header>
  )
