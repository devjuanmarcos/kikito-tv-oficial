...
export const CN_REGISTRY: CnComponentMeta[] = [
  ...
  { name: 'button',          title: 'Button',          group: 'inputs',   description: 'Primitive button with 4 variants, 5 sizes, 7 intents, loading state and icon slots.' },
  { name: 'badge',           title: 'Badge',           group: 'inputs',   description: 'Inline label with 4 variants, 3 sizes, 7 intents, dot indicator and dismiss action.' },
  { name: 'input',           title: 'Input',           group: 'inputs',   description: 'Primitive text input with 3 variants, 3 sizes, status states, icon and prefix/suffix slots.' },
  { name: 'label',           title: 'Label',           group: 'inputs',   description: 'Accessible form label with required/optional markers, hint text and size variants.' },
