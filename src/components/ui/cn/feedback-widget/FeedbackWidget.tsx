...
import { fadeIn, transitionStandard } from "@/lib/motion";
...
export function FeedbackWidget({
  ...
  // AnimatePresence mode="wait": antes, o swap form -> "Thank you!" era um `if (submitted)
  // return <div>` cru -- a arvore inteira trocava instantaneamente, sem transicao nenhuma.
  // Achado na varredura de showcase, 2026-08-30.
  if (submitted) {
    return (
