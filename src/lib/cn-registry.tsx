...
export const CN_REGISTRY: CnComponentMeta[] = [
  ...
  },
  {
    ...
    title: "Code Block",
    group: "display",
    description: "Code block with filename tab, line numbers, copy button, scrollable maxHeight and multi-file tabs.",
    filePath: "src/components/ui/cn/code-block/CodeBlock.tsx",
    peerDeps: ["@/lib/utils"],
    registryDeps: ["button"],
    keywords: ["multi-file", "abas", "tabs", "arquivos"],
    variants: [
      {
        prop: "files",
        value: "CodeBlockFile[]",
        label: "Multi-arquivo",
        status: "stable",
        note: "Abas trocando entre arquivos diferentes ({ filename, code, language? }). Origem: shadcndashboard, aprovado em docs/component-import/variant-intake/DECISIONS.md #7 — abas por linguagem (curl/JS/Python do mesmo conteúdo) não entrou nesta rodada.",
      },
    ],
    props: [
      {
        name: "code",
        type: "string",
        description: "Código a ser exibido (modo single-file, ignorado quando `files` é passado)",
      },
      { name: "language", type: "string", description: "Label da linguagem exibido no topo (sem syntax highlight)" },
      { name: "filename", type: "string", description: "Nome do arquivo exibido no topo" },
      {
        name: "files",
        type: "CodeBlockFile[]",
        default: "undefined",
        description: "Modo multi-arquivo: { filename, code, language? }[] — renderiza abas no topo",
      },
      {
        name: "defaultFileIndex",
        type: "number",
        default: "0",
        description: "Aba ativa inicial em modo `files` (uncontrolled)",
      },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "rows", type: "number", default: "5", description: "Linhas visíveis do textarea" },
      { name: "placeholder", type: "string", description: "Placeholder do textarea" },
      { name: "label", type: "string", description: "Label do campo" },
      { name: "showSentences", type: "boolean", default: "true", description: "Exibir contagem de frases" },
      { name: "showReadTime", type: "boolean", default: "true", description: "Exibir tempo de leitura estimado" },
      { name: "className", type: "string", description: "Classes CSS extras" },
      { name: "style", type: "CSSProperties", description: "Estilos inline pro container" },
    ],
  },
  ...
  },
  {
    ...
    props: [
      ...
      { name: "stats", type: "UserStat[]", default: "[]", description: "Array de { label, value } para métricas" },
  ...
  // ── calendar
  {
    ...
    title: "Calendar",
    group: "inputs",
    description: "Month calendar grid with single/range/multiple selection, event chips and external navigation.",
    filePath: "src/components/ui/cn/calendar/Calendar.tsx",
    keywords: ["range", "multiple", "date range", "multi-select dates"],
    variants: [
      {
        prop: "mode",
        value: "range",
        label: "Range",
        status: "stable",
        note: "Seleção de intervalo (clique 2x: início/fim) direto no Calendar standalone — não delega mais só pro DatePicker. Origem: calendar-04/06/09.tsx do shadcndashboard.",
        aliases: ["date range", "range calendar"],
      },
      {
        prop: "mode",
        value: "multiple",
        label: "Multiple",
        status: "stable",
        note: "Qualquer número de datas, cada uma alternada independente.",
        aliases: ["multi-select", "multiple dates"],
      },
    ],
    props: [
      {
        ...
        default: "'single'",
        description:
          "'single' delega pro DatePicker mode='inline' (comportamento original inalterado); 'range' e 'multiple' são implementados no próprio Calendar",
      },
      {
        name: "value",
        type: "Date | CalendarRange | Date[]",
        description: "Valor selecionado (controlado) — formato depende de `mode`",
      },
      { name: "defaultValue", type: "Date | CalendarRange | Date[]", description: "Valor inicial (não-controlado)" },
      {
        name: "onChange",
        type: "(value: Date | CalendarRange | Date[]) => void",
        description: "Callback ao selecionar — formato depende de `mode`",
      },
      { name: "events", type: "CalendarEvent[]", description: "Chips de eventos nos dias (só mode='single')" },
      {
        name: "onEventClick",
        type: "(event: CalendarEvent) => void",
        description: "Callback ao clicar em evento (só mode='single')",
      },
      { name: "className", type: "string", description: "Classes CSS extras" },
      { name: "style", type: "React.CSSProperties", description: "Estilos inline extras" },
    ],
  ...
  // ── search-input
  {
    ...
    props: [
      ...
      { name: "placeholder", type: "string", default: "'Search…'", description: "Placeholder" },
      { name: "size", type: "'sm' | 'md' | 'lg'", default: "'md'", description: "Tamanho do campo" },
  ...
  // ── signature-pad
  {
    ...
    props: [
      ...
      { name: "height", type: "number", default: "160", description: "Altura do canvas (px)" },
      { name: "lineWidth", type: "number", default: "2", description: "Espessura do traço" },
      {
        name: "color",
        type: "string",
        default: "undefined",
        description: "Cor do traço (padrão: acompanha o tema via --ks-text)",
      },
      { name: "backgroundColor", type: "string", default: "'transparent'", description: "Cor de fundo do canvas" },
      ...
      { name: "saveLabel", type: "string", default: "'Save'", description: "Texto do botão de salvar" },
      { name: "clearLabel", type: "string", default: "'Clear'", description: "Texto do botão de limpar" },
      { name: "placeholder", type: "string", default: "'Sign here'", description: "Texto exibido no canvas vazio" },
