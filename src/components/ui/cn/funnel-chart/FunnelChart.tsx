        ...
        return (
          <React.Fragment key={stage.label}>
            {showConversion && i > 0 && convRate !== null && (
              <div className="flex items-center gap-1.5 justify-center text-[0.6875rem] text-faint">
                <span>▼</span>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <span className="text-white font-medium text-[0.8125rem] px-2 truncate">{stage.label}</span>
              </div>
              {(showValues || showPercent) && (
                <div className="shrink-0 flex gap-1.5 text-[0.75rem]">
