      ...
      >
        {actions.map((action, i) => (
          <div key={action.id} className="relative group">
            ...
            <span
              className={cn(
                "absolute text-body-caption font-medium bg-graphite text-foreground px-2 py-0.5 rounded-(--radius-sm) whitespace-nowrap opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity",
