          ...
          <tr>
            ...
            {plans.map((plan) => (
              ...
              >
                ...
                {plan.description && <div className="text-body-caption text-muted mt-1">{plan.description}</div>}
                <div className="mt-3">
                  <Button
                    onClick={plan.onCta}
        ...
        <tbody>
          {features.map((feature, i) => (
            <tr key={i} className="border-t border-rule">
              ...
              {plans.map((plan) => (
                <td key={plan.id} className={cn("text-center py-3 px-4", plan.highlight && "bg-patina/5")}>
