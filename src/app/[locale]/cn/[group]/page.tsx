  ...
  return (
    <div className="p-8 max-w-3xl">
      <div className="mb-8">
        <Link
          href="/cn"
          className="text-body-callout text-muted hover:text-foreground inline-flex items-center gap-1 mb-4 transition-colors"
        >
      ...
      <div className="grid gap-3">
        {components.map((comp) => (
          ...
          >
            <div>
              <h2 className="text-body-paragraph font-semibold text-foreground group-hover:text-patina transition-colors">
                {comp.title}
              </h2>
            ...
            <svg
              ...
              width={14}
              height={14}
              className="text-faint group-hover:text-patina transition-colors shrink-0"
            >
