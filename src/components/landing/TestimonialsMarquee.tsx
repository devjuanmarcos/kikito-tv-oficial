  ...
  return (
    <section className="tm" aria-label="Depoimentos da comunidade">
      <style>{`
        ...
        .tm-coin { display: grid; place-items: center; width: 28px; height: 28px; border-radius: 50%; flex-shrink: 0; font-size: 0.625rem; font-weight: 700; color: var(--ks-kinpaku-fg); background: var(--ks-kinpaku); }
