...
const ChevronIcon = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width={14} height={14}><polyline points="6 9 12 15 18 9"/></svg>
const CheckIcon   = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" width={12} height={12}><polyline points="20 6 9 17 4 12"/></svg>
const XSmall      = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" width={10} height={10}><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg>
...
export function Combobox({
  ...
  const helper   = errorText ? { text: errorText, isError: true } : helperText ? { text: helperText, isError: false } : null
    ...
    <div ref={wrapRef} className={cn('flex flex-col gap-[0.375rem] w-full relative', className)}>
      ...
      <div
        className={cn(
          ...
          hasError && 'border-[color-mix(in_oklch,var(--ks-danger)_55%,transparent)] focus-within:border-danger focus-within:shadow-[0_0_0_3px_color-mix(in_oklch,var(--ks-danger)_18%,transparent)]',
      ...
      >
        ...
        <input
          ...
          role="combobox"
        />
        <span className={cn('absolute right-[0.625rem] top-1/2 -translate-y-1/2 text-faint pointer-events-none transition-transform duration-[180ms]', open && 'rotate-180')}>
          <ChevronIcon />
        </span>
      </div>
              ...
              : filtered.map((opt, idx) => (
                ...
                >
                  ...
                  {selected.includes(opt.value) && (
                    <span className="ml-auto text-patina"><CheckIcon /></span>
                  )}
                </button>
              ))
            }
